...
class LoginController
{
    ...
    protected function performRedirectToLogin()
    {
        ...
        $service = GeneralUtility::makeInstance(\Widas\Cidaas\Service\OAuthService::class);
    ...
    protected function performRedirectAfterLogin()
    {
        ...
        $redirectUrl = $_SESSION['oidc_referer'];            
    ...
    protected function performRedirectToLogout()
    {
        ...
        $logoutUrl = $this->settings['oidcEndpointLogout'];
